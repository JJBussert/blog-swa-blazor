...
{
    public static IConfigurationBuilder AddEnvFile(this IConfigurationBuilder builder, string envFile = ".env")
    {
        var currentDirPath = Path.Combine(Directory.GetCurrentDirectory(), envFile);

        return builder.Add(new EnvFileConfigurationSource(currentDirPath));
    }
}
